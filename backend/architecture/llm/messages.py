...
Bridges Creamy's role-dict messages and core ``Tool`` objects to the LangChain
...
from backend.architecture.tool.tools import model_tools  # noqa: F401  (kept for API parity)

if TYPE_CHECKING:
    from backend.architecture.core.tools import Tool, ToolContext
